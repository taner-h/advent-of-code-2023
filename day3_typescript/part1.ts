...
symbols.forEach((symbol) => {
  ...
  partNumbers.push(...partNumbersOfSymbol);
});

const uniquePartNumbers: Set<EngineNumber> = new Set(partNumbers);

console.log([...uniquePartNumbers]);

const total = [...uniquePartNumbers].reduce(
